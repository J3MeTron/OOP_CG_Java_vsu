...
TriangleGrad_alt::TriangleGrad_alt(const int absX, const int absY,
...
TriangleGrad_alt::~TriangleGrad_alt()
{

}

QRectF TriangleGrad_alt::boundingRect() const
{
...
void TriangleGrad_alt::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
